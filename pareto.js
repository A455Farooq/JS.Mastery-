...
const slideTitles = [
  "Hovden Consult AS = MODERAT RISIKO RAPPPORT",
  "Vold Regnskap AS = HØY RISIKO RAPPORT",
  "ISHA CONSULTING AS = MODERAT RISIKO RAPPORT",
  "Haugen & Haugen AS = MIDDEL RISIKO RAPPORT",
  "S.A.M Tax AS = HØY RISIKO RAPPORT",
  "RELIANCE CONSULTING AS = HØY RISKO RAPPORT",
